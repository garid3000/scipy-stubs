...
class VertexBase(abc.ABC):
    ...
    nn: Untyped
    index: Untyped
    def __init__(self, x, nn: Untyped | None = ..., index: Untyped | None = ...) -> None:
        ...
...
class VertexScalarField(VertexBase):
    check_min: bool
    check_max: bool
    def __init__(self, x, field: Untyped | None = ..., nn: Untyped | None = ..., index: Untyped | None = ..., field_args=..., g_cons: Untyped | None = ..., g_cons_args=...) -> None:
        ...
...
class VertexVectorField(VertexBase, metaclass=abc.ABCMeta):
    def __init__(self, x, sfield: Untyped | None = ..., vfield: Untyped | None = ..., field_args=..., vfield_args=..., g_cons: Untyped | None = ..., g_cons_args=..., nn: Untyped | None = ..., index: Untyped | None = ...) -> None:
        ...
...
class VertexCacheIndex(VertexCacheBase):
    ...
    def __getitem__(self, x, nn: Untyped | None = ...) -> Untyped:
        ...
...
class VertexCacheField(VertexCacheBase):
    ...
    def __init__(self, field: Untyped | None = ..., field_args=..., g_cons: Untyped | None = ..., g_cons_args=..., workers: int = ...) -> None:
        ...
