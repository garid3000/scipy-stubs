...
def shgo(func, bounds, args=..., constraints: Untyped | None = ..., n: int = ..., iters: int = ..., callback: Untyped | None = ..., minimizer_kwargs: Untyped | None = ..., options: Untyped | None = ..., sampling_method: str = ..., *, workers: int = ...) -> Untyped:
    ...
...
class SHGO:
    ...
    LMC: Untyped
    res: Untyped
    def __init__(self, func, bounds, args=..., constraints: Untyped | None = ..., n: Untyped | None = ..., iters: Untyped | None = ..., callback: Untyped | None = ..., minimizer_kwargs: Untyped | None = ..., options: Untyped | None = ..., sampling_method: str = ..., workers: int = ...) -> None:
        ...
    ...
    def minimise_pool(self, force_iter: bool = ...):
        ...
    ...
    def construct_lcb_delaunay(self, v_min, ind: Untyped | None = ...) -> Untyped:
        ...
    
    def minimize(self, x_min, ind: Untyped | None = ...) -> Untyped:
        ...
    
    def sort_result(self) -> Untyped:
        ...
    
    def fail_routine(self, mes: str = ...):
        ...
    
    C: Untyped
    def sampled_surface(self, infty_cons_sampl: bool = ...):
        ...
    ...
    def delaunay_triangulation(self, n_prc: int = ...) -> Untyped:
        ...
...
class LMapCache:
    ...
    def add_res(self, v, lres, bounds: Untyped | None = ...):
        ...
