...
class LaplacianNd(LinearOperator):
    ...
    def __init__(self, grid_shape, *, boundary_conditions: str = ..., dtype=...) -> None:
        ...
    
    def eigenvalues(self, m: Untyped | None = ...) -> Untyped:
        ...
    
    def eigenvectors(self, m: Untyped | None = ...) -> Untyped:
        ...
