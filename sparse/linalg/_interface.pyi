...
class LinearOperator:
    ...
    def __matmul__(self, other: LinearOperator | onpt.CanArray[tuple[int, ...], np.dtype[np.generic]], /) -> _ScaledLinearOperator | UntypedArray:
        ...
    
    def __rmatmul__(self, other: LinearOperator | onpt.CanArray[tuple[int, ...], np.dtype[np.generic]], /) -> _ScaledLinearOperator | UntypedArray:
        ...
...
class _CustomLinearOperator(LinearOperator):
    args: Untyped
    def __init__(self, shape, matvec, rmatvec: Untyped | None = ..., matmat: Untyped | None = ..., dtype: Untyped | None = ..., rmatmat: Untyped | None = ...) -> None:
        ...
