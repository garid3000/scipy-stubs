...
class Rotation:
    ...
    def reduce(self, left: Rotation | None = ..., right: Rotation | None = ..., return_indices: bool = ...) -> Rotation | tuple[Rotation, npt.NDArray[np.float64], npt.NDArray[np.float64]]:
        ...
    ...
    @classmethod
    def align_vectors(cls, a: npt.ArrayLike, b: npt.ArrayLike, weights: npt.ArrayLike | None = ..., return_sensitivity: bool = ...) -> tuple[Rotation, float] | tuple[Rotation, float, npt.NDArray[np.float64]]:
        ...
