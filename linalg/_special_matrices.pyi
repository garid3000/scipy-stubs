...
__all__ = ["block_diag", "circulant", "companion", "convolution_matrix", "dft", "fiedler", "fiedler_companion", "hadamard", "hankel", "helmert", "hilbert", "invhilbert", "invpascal", "kron", "leslie", "pascal", "toeplitz"]
...
def toeplitz(c: npt.ArrayLike, r: npt.ArrayLike | None = ...) -> _Array_2d:
    ...

def circulant(c: npt.ArrayLike) -> _Array_2d:
    ...

def hankel(c: npt.ArrayLike, r: npt.ArrayLike | None = ...) -> _Array_2d:
    ...
...
def helmert(n: spt.AnyInt, full: bool = ...) -> _Array_f8_2d:
    ...
...
@overload
def invhilbert(n: spt.AnyInt, exact: Literal[False] = ...) -> _Array_f8_2d:
    ...
...
@overload
def pascal(n: spt.AnyInt, kind: _SymmetryKind = ..., exact: Literal[True] = ...) -> _Array_u8_2d | _Array_O_2d:
    ...
...
@overload
def invpascal(n: spt.AnyInt, kind: _SymmetryKind = ..., exact: Literal[True] = ...) -> _Array_i8_2d | _Array_O_2d:
    ...
...
def dft(n: spt.AnyInt, scale: Literal["sqrtn", "n"] | None = ...) -> _Array_c16_2d:
    ...
...
def convolution_matrix(a: npt.ArrayLike, n: spt.AnyInt, mode: spt.CorrelateMode = ...) -> _Array_2d:
    ...
