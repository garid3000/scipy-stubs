...
__all__ = ["SYS_LITTLE_ENDIAN", "MatFile4Reader", "MatFile4Writer", "VarHeader4", "VarReader4", "VarWriter4", "arr_to_2d", "mclass_info", "mdtypes_template", "miDOUBLE", "miINT16", "miINT32", "miSINGLE", "miUINT8", "miUINT16", "mxCHAR_CLASS", "mxFULL_CLASS", "mxSPARSE_CLASS", "np_to_mtypes", "order_codes"]
...
class VarReader4:
    ...
    def array_from_header(self, hdr, process: bool = ...) -> Untyped:
        ...
    
    def read_sub_array(self, hdr, copy: bool = ...) -> Untyped:
        ...
...
def arr_to_2d(arr, oned_as: str = ...) -> Untyped:
    ...
...
class VarWriter4:
    ...
    def write_header(self, name, shape, P=..., T=..., imagf: int = ...):
        ...
