...
class IntFormat:
    @classmethod
    def from_number(cls, n, min: Untyped | None = ...) -> Untyped:
        ...
    
    width: Untyped
    repeat: Untyped
    min: Untyped
    def __init__(self, width, min: Untyped | None = ..., repeat: Untyped | None = ...) -> None:
        ...
...
class ExpFormat:
    ...
    repeat: Untyped
    min: Untyped
    def __init__(self, width, significand, min: Untyped | None = ..., repeat: Untyped | None = ...) -> None:
        ...
