...
class netcdf_file:
    ...
    dimensions: Untyped
    variables: Untyped
    def __init__(self, filename, mode: str = ..., mmap: Untyped | None = ..., version: int = ..., maskandscale: bool = ...) -> None:
        ...
...
class netcdf_variable:
    ...
    def __init__(self, data, typecode, size, shape, dimensions, attributes: Untyped | None = ..., maskandscale: bool = ...) -> None:
        ...
