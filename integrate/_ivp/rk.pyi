...
MIN_FACTOR: float
MAX_FACTOR: int
def rk_step(fun: UntypedCallable, t: Untyped, y: Untyped, f: Untyped, h: Untyped, A: Untyped, B: Untyped, C: Untyped, K: Untyped) -> Untyped:
    ...
...
class RungeKutta(OdeSolver):
    ...
    h_previous: Untyped
    def __init__(self, /, fun: UntypedCallable, t0: Untyped, y0: Untyped, t_bound: Untyped, max_step: Untyped = ..., rtol: float = ..., atol: float = ..., vectorized: bool = ..., first_step: Untyped | None = ..., **extraneous: Untyped) -> None:
        ...
