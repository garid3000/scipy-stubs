...
def select_initial_step(fun: UntypedCallable, t0: Untyped, y0: Untyped, t_bound: Untyped, max_step: Untyped, f0: Untyped, direction: Untyped, order: Untyped, rtol: Untyped, atol: Untyped) -> Untyped:
    ...
...
class OdeSolution:
    ...
    side: Untyped
    ts_sorted: Untyped
    def __init__(self, ts: Untyped, interpolants: Untyped, alt_segment: bool = ...) -> None:
        ...
...
def num_jac(fun: UntypedCallable, t: Untyped, y: Untyped, f: Untyped, threshold: Untyped, factor: Untyped, sparsity: Untyped | None = ...) -> Untyped:
    ...
