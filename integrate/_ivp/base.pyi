...
def check_arguments(fun: Callable[[float, npt.NDArray[np.float64]], _ArrayLikeComplex], y0: _ArrayLikeComplex, support_complex: bool) -> (Callable[[float, npt.NDArray[np.float64]], npt.NDArray[np.float64]] | Callable[[float, npt.NDArray[np.float64]], npt.NDArray[np.complex128]]):
    ...
...
class OdeSolver:
    ...
    njev: int
    nlu: int
    def __init__(self, fun: Callable[[float, npt.NDArray[np.float64]], _ArrayLikeComplex], t0: float, y0: _ArrayLikeComplex, t_bound: float, vectorized: bool, support_complex: bool = ...) -> None:
        ...
