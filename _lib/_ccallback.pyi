...
class LowLevelCallable(tuple[CapsuleType, _FuncT_co, _DataT_co], Generic[_FuncT_co, _DataT_co]):
    def __new__(cls, function: _FuncT_co | LowLevelCallable[_FuncT_co, _DataT_co], user_data: Untyped | None = ..., signature: str | None = ...) -> Self:
        ...
    
    @classmethod
    def from_cython(cls, module: ModuleType, name: str, user_data: _UserData | None = ..., signature: str | None = ...) -> Self:
        ...
    
    @override
    def __getitem__(self, idx: Never, /) -> NoReturn:
        ...
