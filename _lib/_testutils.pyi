...
class PytestTester:
    ...
    def __call__(self, /, label: Literal["fast", "full"] = ..., verbose: int = ..., extra_argv: Iterable[str] | None = ..., doctests: bool = ..., coverage: bool = ..., tests: Iterable[str] | None = ..., parallel: int | None = ...) -> bool:
        ...
