...
class Covariance(Generic[_SCT_co]):
    ...
    @staticmethod
    def from_precision(precision: _ArrayLike_uif_2d, covariance: _ArrayLike_uif_2d | None = ...) -> CovViaPrecision:
        ...
...
class CovViaPrecision(Covariance[np.float64]):
    def __init__(self, /, precision: _ArrayLike_uif_2d, covariance: _ArrayLike_uif_2d | None = ...) -> None:
        ...
