...
class gaussian_kde:
    dataset: Untyped
    def __init__(self, dataset, bw_method: Untyped | None = ..., weights: Untyped | None = ...) -> None:
        ...
    ...
    def integrate_box(self, low_bounds, high_bounds, maxpts: Untyped | None = ...) -> Untyped:
        ...
    
    def integrate_kde(self, other) -> Untyped:
        ...
    
    def resample(self, size: Untyped | None = ..., seed: Untyped | None = ...) -> Untyped:
        ...
    ...
    covariance_factor = ...
    def set_bandwidth(self, bw_method: Untyped | None = ...) -> Untyped:
        ...
