...
__all__ = ["Halton", "LatinHypercube", "MultinomialQMC", "MultivariateNormalQMC", "PoissonDisk", "QMCEngine", "Sobol", "discrepancy", "geometric_discrepancy", "scale", "update_discrepancy"]
...
def scale(sample: npt.ArrayLike, l_bounds: npt.ArrayLike, u_bounds: npt.ArrayLike, *, reverse: bool = ...) -> UntypedArray:
    ...
...
def van_der_corput(n: IntNumber, base: IntNumber = ..., *, start_index: IntNumber = ..., scramble: bool = ..., permutations: npt.ArrayLike | None = ..., seed: SeedType = ..., workers: IntNumber = ...) -> UntypedArray:
    ...
...
class QMCEngine(ABC):
    ...
    def random(self, n: IntNumber = ..., *, workers: IntNumber = ...) -> UntypedArray:
        ...
    
    def integers(self, l_bounds: npt.ArrayLike, *, u_bounds: npt.ArrayLike | None = ..., n: IntNumber = ..., endpoint: bool = ..., workers: IntNumber = ...) -> UntypedArray:
        ...
...
class PoissonDisk(QMCEngine):
    ...
    cell_size: Untyped
    grid_size: Untyped
    def __init__(self, d: IntNumber, *, radius: DecimalNumber = ..., hypersphere: Literal["volume", "surface"] = ..., ncandidates: IntNumber = ..., optimization: Literal["random-cd", "lloyd"] | None = ..., seed: SeedType = ..., l_bounds: npt.ArrayLike | None = ..., u_bounds: npt.ArrayLike | None = ...) -> None:
        ...
...
class MultivariateNormalQMC:
    ...
    def random(self, n: IntNumber = ...) -> UntypedArray:
        ...
